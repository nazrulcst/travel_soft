<?php include('inc/header.php');?>		
		<div id="fh5co-tours" class="fh5co-section-gray text-center">
			<div class="container">
				<div class="row">
				...
				<div class="row">
					<div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
						<div href="#"><img src="images/place-1.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
							<div class="desc">
								...
								<a class="btn btn-primary btn-outline" href="visaBooking.php">View Details <i class="icon-arrow-right22"></i></a>
							</div>
						</div>
					</div>
					<div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
					...
					<div class="col-md-12 text-center animate-box">
						<p><a class="btn btn-primary btn-outline btn-lg" href="visaBooking.php">See All Country <i class="icon-arrow-right22"></i></a></p>
					</div>
				</div>
			</div>
		</div>
